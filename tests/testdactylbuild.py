...
class TestDactylBuild(unittest.TestCase):
    dactyl_build.config = {"content_path": "test_files",
                           "pdf_filename_fields": ["display_name"], 
                           ...
                           "pages": [{"name": "filters_page", "filters": ["page_filter"]}, {"name": "test_page", "html": "test.html", "targets": ["test_target"]}, {"name": "md_test"}]}
